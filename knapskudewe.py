...
with upload_data:
    ...
    st.write("Dataset yang digunakan adalah healthcare-dataset-stroke-data dataset yang diambil dari https://www.kaggle.com/code/alyaaselim/telecom-churn-dataset#Telecom-Churn-Dataset")
